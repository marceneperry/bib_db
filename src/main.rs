...
async fn main() {
    ...
    // setup terminal... moved to App::new()
    // enable_raw_mode()?;
    ...
    app.expect("can run app").run().await.expect("did run")
    ...
    //
    //
    //                 let (left, right) = render_books(&app.book_list_state);
    //                 rect.render_stateful_widget(left, book_chunks[0], &mut app.book_list_state);
    ...
    //                     .split(chunks[1]);
    //
    //                 // let editor = Editor::new(env::args_os().skip(1))?.run();
    //                 // rect.render_widget(editor, chunks[1]);
    //
    ...
    //             KeyCode::Char('b') => app.active_menu_item = MenuItem::Book,
    //             KeyCode::Char('s') => app.active_menu_item = MenuItem::ShowBooks,
    //             KeyCode::Char('n') => app.active_menu_item = MenuItem::NewBook,
    //             KeyCode::Char('a') => app.active_menu_item = MenuItem::Article,
    //             KeyCode::Char('l') => app.active_menu_item = MenuItem::ListArticles,
    //             KeyCode::Char('i') => app.active_menu_item = MenuItem::InsertArticle,
    //             _ => {}
    //         },
    //         Some(AppEvent::Tick) => {}
    //         None => {}
